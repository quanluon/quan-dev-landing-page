...
export function getSiteData(locale: Locale) {
  ...
  const projects = locale === "vi"
    ? [
      ...
      { title: "Inventory & Order Processing", eyebrow: "E-commerce / Operations", description: "Hệ thống quản lý kho và đơn hàng theo hướng event-driven, giảm lỗi khi nhiều thao tác xảy ra cùng lúc.", tags: ["NestJS", "RabbitMQ", "PostgreSQL", "React"], type: "webapp", icon: Blocks, visual: "dashboard" },
        ...
        { title: "Marketplace Search Platform", eyebrow: "Marketplace / Search", description: "Kiến trúc search và caching cho marketplace cần phản hồi nhanh, dữ liệu nhiều và dễ mở rộng.", tags: ["Golang", "NestJS", "Redis", "Elasticsearch"], type: "backend", icon: Gauge, visual: "api" },
        { title: "ESG Reporting Workflow", eyebrow: "Enterprise / Reporting", description: "Luồng báo cáo có phân quyền, cô lập dữ liệu theo tenant và tự động tạo file PDF/Excel.", tags: ["NestJS", "PostgreSQL", "AWS Lambda", "Vue"], type: "webapp", icon: BarChart3, visual: "website" },
      ]
    : [
      ...
      { title: "Inventory & Order Processing", eyebrow: "E-commerce / Operations", description: "Inventory and order processing built around event-driven flows to reduce concurrency issues.", tags: ["NestJS", "RabbitMQ", "PostgreSQL", "React"], type: "webapp", icon: Blocks, visual: "dashboard" },
        ...
        { title: "Marketplace Search Platform", eyebrow: "Marketplace / Search", description: "Search and caching architecture for a marketplace that needs fast responses and room to scale.", tags: ["Golang", "NestJS", "Redis", "Elasticsearch"], type: "backend", icon: Gauge, visual: "api" },
        { title: "ESG Reporting Workflow", eyebrow: "Enterprise / Reporting", description: "Reporting workflows with RBAC, tenant data isolation and automated PDF/Excel generation.", tags: ["NestJS", "PostgreSQL", "AWS Lambda", "Vue"], type: "webapp", icon: BarChart3, visual: "website" },
      ];
